...
const ARTICULOS = [
  { id: 1, titulo: 'Guía de poda del almendro: cuándo y cómo hacerlo', categoria: 'Técnicas de cultivo', fecha: '15 marzo 2025', resumen: 'La poda del almendro es fundamental para obtener buenas cosechas. Explicamos los momentos clave y técnicas efectivas para agricultores de Alicante.', emoji: '🌳', tiempo: '5 min' },
  { id: 2, titulo: 'Tratamientos fitosanitarios permitidos en cultivos ecológicos', categoria: 'Fitosanitarios', fecha: '8 marzo 2025', resumen: 'Guía actualizada con los productos fitosanitarios autorizados para agricultura ecológica según la normativa vigente del Ministerio de Agricultura.', emoji: '🌿', tiempo: '8 min' },
  { id: 3, titulo: 'Previsión meteorológica para la comarca: riesgos de helada', categoria: 'Meteorología', fecha: '1 marzo 2025', resumen: 'Análisis de las previsiones meteorológicas y recomendaciones para proteger los cultivos frente a las heladas tardías.', emoji: '🌡️', tiempo: '4 min' },
  { id: 4, titulo: 'Cómo interpretar el análisis de suelo de tu parcela', categoria: 'Técnicas de cultivo', fecha: '22 febrero 2025', resumen: 'El análisis de suelo es la base de una fertilización correcta. Te explicamos cómo leer los valores de pH, materia orgánica y nutrientes.', emoji: '🧪', tiempo: '6 min' },
  { id: 5, titulo: 'Normativa de la PAC 2025: lo que necesitas saber', categoria: 'Normativa', fecha: '15 febrero 2025', resumen: 'Resumen de los principales cambios de la Política Agraria Común para 2025 y cómo afectan a los agricultores de la Comunitat Valenciana.', emoji: '📋', tiempo: '10 min' },
  { id: 6, titulo: 'Riego por goteo: eficiencia y ahorro de agua en verano', categoria: 'Riego', fecha: '8 febrero 2025', resumen: 'El riego por goteo puede reducir el consumo de agua hasta un 50%. Guía práctica para instalar y programar tu sistema.', emoji: '💧', tiempo: '7 min' },
]
